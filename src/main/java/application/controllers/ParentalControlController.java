...
/**
 * Controls parental settings by interfacing between the view and the Parent model.
 * Handles interfacing of password verification, management of allowed gameplay hours, and usage stats.
 * 
 * @author Ryan Wagner
 */
